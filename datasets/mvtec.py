...
class MVTecDataset(Dataset):
    def __init__(self, dataset_path='D:/dataset/mvtec_anomaly_detection', class_name='bottle', is_train=True,
        ...
        # set transforms
        self.transform_x = T.Compose([#T.CenterCrop(1944),
        ...
        self.transform_mask = T.Compose([#T.CenterCrop(1944),
    ...
    def __getitem__(self, idx):
        ...
        i, j, h, w = T.RandomCrop.get_params(
            x, output_size=(self.cropsize, self.cropsize))
        angle = T.RandomRotation.get_params([0,90,180,270])
    ...
    def load_dataset_folder(self):
        ...
        for img_type in img_types:
            ...
            if img_type == 'good':
                ...
                gt_fpath_list = [os.path.join(gt_type_dir, img_fname + '_mask.png') # _mask.png
